// src/components/OpenAIAnalyticsBox.tsx
...
import {
  ...
  CallTypeData,
  CallTypeBreakdown,
} from '../types/openai-assistant-types';
import { COST_PER_MINUTE } from '../constants/assistant-constants';

export const OpenAIAnalyticsBox: React.FC<AnalyticsBoxProps> = ({
  analyticsData,
  dateRange,
  onDateRangeChange,
}) => {
...
export default OpenAIAnalyticsBox;
